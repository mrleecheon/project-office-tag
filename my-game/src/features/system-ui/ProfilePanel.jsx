  ...
  return (
    <section className="messengerPanel profilePanel" aria-label="프로필 패널">
      ...
      <dl className="statusGrid">
        ...
        <div>
          <dt>그루미 관계</dt>
          <dd className="relationshipToneCell">
            <span className="relationshipTone">{storyStatus.relationship.tone}</span>
            {storyStatus.relationship.subLabel ? (
              <span
                className="relationshipSubLabel"
                title={storyStatus.relationship.subLabel}
              >
                {storyStatus.relationship.subLabel}
              </span>
            ) : null}
