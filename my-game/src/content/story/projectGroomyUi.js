...
const clueLabels = {
  ...
  homicideConclusion: {
    title: '타살 결론',
    body: '박서이는 누군가에 의해 살해되었다. 범인은 아직 불명.',
  },
  groomyMotiveConclusion: {
    title: '그루미 연관 결론',
    body: '박서이의 죽음은 그루미·배터리 라인과 연결되어 있다. 직접 실행 여부는 미확정.',
  },
  groomyBatteryLead: {
    title: '그루미 배터리 단서',
  ...
  seoiDiaryPartial: {
    title: '박서이의 일기 (일부)',
    body: '보관실 벽 틈에서 발견한 수첩 마지막 장. "명령이 있었다. 그 애는 그저 그걸 따랐을 뿐이다. 그래서 나는 그 애를 미워할 수 없다."',
  },
  resignationLetter: {
    title: '미제출 사직서',
    body: '소속: 운영지원팀 · 성명: 박서이. 사유: "여기 너무 오래 있었습니다." 날짜 칸은 비어 있다.',
  },
  seoiRecorderPartial: {
    title: '박서이의 녹음기 (미재생)',
    body: '책상 서랍에서 발견한 휴대용 녹음기. 배터리가 거의 다 됐지만 아직 재생하지 않았다.',
  },
  seoiRecorder: {
    title: '박서이의 녹음기',
    body: '"당신도 나처럼 여기 온 거겠죠. 누군가를 살리려고." 전임자도 같은 목적으로 잠입했다는 증거.',
  },
  seoiRecorderComplete: {
    title: '박서이의 녹음기 (완본)',
    body: '"나는 너를 미워하지 않아. 너는 그냥, 명령을 따랐을 뿐이니까." 박서이의 마지막 유언.',
  },
  familyPhotoAnomaly: {
    title: '가족사진의 결손',
  ...
  iseolPrivateNote: {
    title: '강이솔의 쪽지',
    body: '강이솔은 그날 밤, 평소보다 늦게 퇴근했다. 신입이 들어온 첫날부터, 그 사번이 박서이의 것이라는 걸 알고 있었다. 자료보관실 사건 당밤 복도에서 기다렸고, 추궁은 두려움이었다. CH4 채널의 모든 태도는 같은 두려움에서 나왔다. "나는 그루미를 미워해야 하는지, 박서이처럼 미워하지 않아야 하는지 아직도 모르겠다. 다만 한 가지는 안다. 다음에 누가 또 이 사번을 물려받게 되든, 그 사람에게는 적어도 내가 하지 못한 말을 해주고 싶다. 늦지 않게."',
  },
}
...
const flagLabels = {
  ...
  namedSeoiFirst: '박서이 선임 이름을 먼저 확인',
  pressedSeoiTopic: '전임자 로그를 즉시 추궁',
  ch1AskedAccidentRecord: '사망 사고 처리 기록 질문',
  ch1CheckedMissingMemorialNotice: '추모 공지 부재 확인',
  ch1FoundFridgeBatterySticker: '냉장고 배터리 스티커 발견',
  ch1ReadBadgeAuditPoster: '사원증 감사 포스터 확인',
  ch1FoundIncidentRehearsalFile: '사고 대응 리허설 파일 발견',
  ch1CheckedChoiSeat: '최민준 팀장 자리 조사',
  ch1SawIseolBlockMemo: '이솔의 그루미 차단 메모 목격',
  askedGroomyPersonalThought: '그루미 개인적 생각 질문',
  treatedGroomyAsTool: '그루미를 도구로 대함',
  askedWhoDislikesCard: '사원증 불편 대상 질문',
  ...
  learnedSeoiTriedShutdown: '전임자의 그루미 종료 시도 파악',
  ...
  ch3FoundResignationLetter: '미제출 사직서 발견',
  ch3_sharedLetterWithIseol: '강이솔에게 사직서 공유',
  ch3FoundRecorderNotPlayed: '녹음기 확보 (미재생)',
  ch3_foundSeoiBody: '박서이 시체 발견',
  ch3_recoveredSeoiDiary: '박서이 일기 회수',
  ch3_listenedSeoiRecording: '박서이 녹음기 청취',
  ch3HeardFullSeoiRecording: '박서이 녹음 완본 청취',
  pressedGroomyAtBody: '시체 앞에서 그루미를 추궁',
  comfortedGroomyAtBody: '시체 앞에서 그루미를 위로',
  reportedToSystemFirst: '시체 발견 직후 CARETAKER 신고',
  groomyAdmittedFeelingFear: '그루미가 두려움을 인정',
  pressedCaretakerAboutDeath: 'CARETAKER에 사망 원인 질문',
  avoidedCaretakerConfrontation: 'CARETAKER 대면 회피',
  caretakerHintedGroomyWasDuty: 'CARETAKER의 "의무" 발언 목격',
  ch3_noticedPhotoAnomaly: '가족사진의 결손 발견',
  askedAboutSixthPerson: '여섯 번째 사람에 대해 질문',
  silentAboutSixthPerson: '여섯 번째 사람에 대해 침묵',
  groomyFrozeOnSixthPerson: '그루미가 6번째 인물에 말을 잃음',
  ch3_glimpsedRealBathroom: '보정 OFF 상태의 화장실 목격',
  ch3_caretakerFirstContact: 'CARETAKER 첫 직접 경고',
  ch3_recalledGuardian: '보호자 회상',
  ch3_photoBranchResolved: '가족사진 분기 완료',
  pressedGroomyAboutAbsence: '그루미 공백을 추궁',
  reassuredGroomyAboutAbsence: '그루미 공백에 안심시킴',
  groomyDescribedHandSensation: '그루미의 손 움직임 잔상',
  toldGroomyAboutBathroomBlood: '화장실 핏자국을 그루미에게 고백',
  hidBathroomVision: '화장실 환영을 숨김',
  groomyRecognizedBathroomBlood: '그루미가 화장실 핏자국을 기억',
  ch3_groomyLeakBlood: '그루미의 화장실 기억 누출 (복선 #3)',
  ch3ProceededToFloor3: '3층 재방문 결정',
  ch3HesitatedBeforeFloor3: '3층 방문을 망설임',
  ch3_openedStorageDoor: '3층 자료보관실 진입',
  ch3_foundStorageChair: '보관실 의자 단서',
  ch3_foundSeoiIdInStorage: '보관실 사원증 단서',
  ch3_foundRecorderFull: '보관실 녹음기 완본',
  ch3ConcludedHomicide: '타살 결론 (CH3)',
  ch3ConcludedGroomyLinkedDeath: '그루미·배터리 연관 결론 (CH3)',
  ch3WithheldFinalDeduction: '최종 추론 보류 (CH3)',
  ...
  glimpsedPriorExecutions: '자료보관실에서 이전 실행 로그 목격',
  witnessedIsolatedHourPlayback: '격리된 1시간 백업 재생',
  recalledGuardianAraDuringCore: 'B5 하강 중 보호자 아라 회상',
  ...
  dismantledWithFullKnowledge: '가까운 사이였지만 해체 선택 (badA)',
}
