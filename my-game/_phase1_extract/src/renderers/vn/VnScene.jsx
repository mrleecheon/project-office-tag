...
export default function VnScene({ scene, context, onChoice, onDone }) {
  ...
  }, [availableChoices.length, done, important, index, line?.char, onDone, scene.id, scene.lines, scene.next, scene.returnTo, text])
  ...
  return (
    <div className={`vnScene ${important ? 'important' : ''}`} onClick={advance}>
